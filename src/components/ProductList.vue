    ...
    products: [
      {
        ...
        year: '2020',
        category: '静岡県伊東市富戸のプロモーション',
        use: 'VR AR ホームページ制作 画像作成　TwitterAPI　processing',
        urls: [
          // TODO: ここにリンクしたいURLを入れてね
          'https://www.meisei-u.ac.jp/2021/2021031504.html?r=rss'
        ],
      },

      {
        ...
        name: 'ここにタイトルを入れてね',
        // TODO: ここに差し替えたい画像のパスを入れてね
        image: require('/Users/shimizukaito/Downloads/壁紙候補/東京中央銀行背景.jpeg'),
        year: '2020',
        category: '静岡県伊東市富戸のプロモーション',
        use: 'VR AR ホームページ制作 画像作成　TwitterAPI　processing',
        urls: [
